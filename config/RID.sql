...
CREATE TABLE users (
    ...
    email VARCHAR(100) COMMENT 'Correo electrónico (requerido para Administrador)',
...
CREATE TABLE tickets (
    ...
    company_name VARCHAR(100) COMMENT 'Nombre comercial de la empresa',
    company_phone VARCHAR(20) COMMENT 'Número de contacto de la empresa',
    company_logo_path VARCHAR(255) COMMENT 'Ruta de la imagen del logotipo',
    commercial_message TEXT COMMENT 'Mensaje comercial configurable',
